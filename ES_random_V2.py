...
driver = None
wait = None
website_main = "https://es.levenhuk.com/"
...
class OrderContext:
    def __init__(self):
        ...
        self.sku_lists = {
            'price_classes': {
                ...
                1: [84558, 70818, 79054, 78666, 72098], # 70-120 EU

                2: [72481, 69184, 67698, 72100, 83839] # 120+ EU - TBD for cash
        ...
        self.fees = {
                'shipping': {
                    'standard': {
                        ...
                        'over_70': { # Includes price classes 1 & 2
                            'amount': 0,
    ...
    def get_all_skus(self):
        ...
        all_skus = self.sku_lists['price_classes'][0] + self.sku_lists['price_classes'][1] + self.sku_lists['price_classes'][2]
        return all_skus
